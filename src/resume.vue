<template>
  <section class="overview">
    <img
      src="https://files20220620.oss-cn-shanghai.aliyuncs.com/other/me.jpg"
      title="韦现法的照片"
    >
    <h1 class="name">韦现法</h1>
    <div class="items">
      <span>1994.09 出生</span>
      <span>2018.07 毕业</span>
      <span>男</span>
    </div>
    <div class="items">
      <span>身体健康</span>
  ...
  <section>
    ...
    <ul>
      ...
      <li>web 全栈开发，熟悉 vue + node 组合</li>
      <li>熟悉 HTML5、CSS3、ES6/ES6+</li>
      <li>熟悉微信等各类小程序开发</li>
      <li>熟悉 REST API 规范</li>
      <li>熟悉 HTTP(S)，了解 TCP、UDP</li>
      <li>具备良好的文档阅读、编写能力</li>
      <li>前端：Vue、jQuery、ECharts、Element-UI</li>
      <li>后端：Express、Koa、Sequelize、Knex</li>
      <li>开发工具：npm、webpack、rollup、parcel</li>
  ...
  <section>
    ...
    <section>
      ...
      <p>中文名：<a href="https://github.com/ppz-pro/ppz.vscode">皮皮仔</a>。是一款 vscode 插件，提供关系型数据库的图形操作界面。</p>
      ...
      <div>技术点：</div>
      <ul>
        <li>平台：VS Code ^1.47.3</li>
        <li>兼容 Windows、MacOS、Linux 操作系统</li>
        <li>Vue</li>
        <li>Knex</li>
        <li>node-mysql2</li>
        <li>node-sqlite3</li>
      ...
      <p><b>难点一</b> 在于统一各主流数据库的操作，目前支持 MySQL、PostgreSQL、MSSQL、Sqlite3 以及兼容以上“标准”的数据库。比如 MariaDB、TiDB、stoneDB 等均属于 MySQL 系，可以使用 MySQL 驱动连接；CockroachDB 等可以使用 PostgreSQL 的驱动；Azure Data 等可以使用 MSSQL 驱动。（OracleDB 的支持正在开发中。）</p>
    ...
    <section>
      ...
      <p>全名“比茵沃智能枪弹柜管理系统”，这是一个面向政府的，高定制化的业务系统。主要用于管理警局、法院、押运组织的枪支弹药。</p>
      <div>Features：</div>
      <ul>
        <li>人脸、指纹识别警员身份，匹配枪支弹药</li>
        <li>取、还日志</li>
        <li>本地、远程审批</li>
      </ul>
      <p><b>我的主要工作</b> 在于维护系统的“操作端”和“数据服务端”部分，并添加新功能。期间主导过一次前端项目重构，用 Vue.js 替换原来的 jQuery + Bootstrap。</p>
      <p><b>难点</b> 在于实现组织内部非常复杂的取枪流程和特殊的业务场景。比如“胁迫指纹”是指，取枪警员选定特定的手指，当使用这个手指验证身份时，会触发无声报警，报警信息直达各级指定的负责人。验证后，要发出“假的 bug”，但为保障警员生命安全，则要通过其他途径，允许警员把物品交给歹徒。主要用于机构遭遇入侵，被胁迫取枪。业务较为敏感，与公司签有保密协议，不方便多说。</p>
      <div>技术点：</div>
      <ul>
        <li>Ubuntu18.04、Nginx、Electron</li>
        <li>Vue、Node</li>
    ...
    <section>
      <h5>
        数据可视化平台
        <span>2018.10 ~ 2019.11</span>
      </h5>
      <p>全名“大蓝洞数据可视化平台”，一个数据可视化项目。简单来说，就是对数据进行筛选、聚合、提取之后，用图表的形式展示。</p>
      <div>Features：</div>
      <ul>
        <li>支持配置数据源结构</li>
        <li>折线图、雷达图、盒须图、矩形阵图等</li>
        <li>制作数据可视化大屏</li>
        <li>支持手动拖拽、缩放、排列图表</li>
      </ul>
  ...
  <section>
    ...
    <section>
      ...
      <ul>
        <li>2018.7 ~ 2019.11</li>
        <li>职位：前端开发工程师</li>
        <li>主要项目：大蓝洞数据可视化平台</li>
      </ul>
      <p>除“大蓝洞”数据可视化平台以外，还参与过公司老项目的维护。当时工作内容仅在前端，期间开始学习 Node.js，为全栈开发做准备。</p>
    </section>
  </section>
  <section>
    <h4>教育经历</h4>
